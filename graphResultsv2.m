...
function graphResultsv2(RPM,results_struct,dir_model,blade_model,endwall_model,cfd_model)
...
if (strcmpi(blade_model.blade_type,'rotor') == 1)
   %% Rotor graphs - beta3, W3, rotor efficiency, stage efficiency, Cske
	...
	f = figure(15);
    hold all;
	plot(X3_CFD_HSke,X3_CFD_span,'o-b');legend('annular','contoured','location','SE','orientation','vertical');
