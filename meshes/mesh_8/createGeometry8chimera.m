function createGeometry8chimera(blade_model,dir_model,resource_model,x,iga,GUIhandles)
...
system(sy1c);
sy2a = sprintf('cp %s%s_inputfile2 ./inputfile',dir_model.base_dir,blade_model.blade_type);
system(sy2a);
